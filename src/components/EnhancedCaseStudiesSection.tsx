    ...
    <div className="mb-10">
      <div className="max-w-4xl mx-auto">
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl bg-black">
          <div className="aspect-video">
            <iframe
              ...
              title="Sun Exchange B2B Campaign Video"
              frameBorder="0"
        ...
        <p className="text-center text-gray-600 mt-4 text-sm italic">
          Campaign strategy and impact demonstration
        </p>
      </div>
    </div>
  ...
  <div className="p-10">
    ...
    <div className="mb-10">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-center text-gray-600 mt-4 text-sm italic">
          Documentary film driving international impact investment
        </p>
      </div>
    </div>
